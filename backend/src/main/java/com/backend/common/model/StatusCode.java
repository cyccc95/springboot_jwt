...
public enum StatusCode {
    ...
    ,CODE_603(603, "이메일을 입력해주세요.")
    ,CODE_604(604, "비밀번호를 입력해주세요.")
    ,CODE_605(605, "로그인 아이디가 일치하지 않습니다.")
    ,CODE_606(606, "비밀번호가 일치하지 않습니다.")
    ,CODE_607(607, "알 수 없는 로그인 정보입니다.")
    ,CODE_608(608, "이미 존재하는 아이디입니다.")
    ,CODE_609(609, "이미 존재하는 닉네임입니다.")
    ,CODE_610(610, "중복체크 타입이 올바르지 않습니다.")
    ,CODE_611(611, "현재 비밀번호와 일치하지 않습니다.")
    ,CODE_612(612, "새 비밀번호와 확인 비밀번호가 일치하지 않습니다.")
